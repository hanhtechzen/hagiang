...
<section class="detail-tour bg-[#F4F4F4] py-[50px] pt-[32px]" x-data="ScrollClick()">
	...
	<div class="wrap-info-detail-tour mt-[50px]">
		...
		<div class="content-detail-tour">
			<div id="lich-trinh" class="noidung-tour py-[20px] border-b-[1px] border-b-[#000]/[.12]">
				<div class="container">
			...
			<div id="thong-tin" class="noidung-tour py-[20px] border-b-[1px] border-b-[#000]/[.12]">
				<div class="container">
			...
			<div id="dat-tour" class="noidung-tour pb-0 py-[20px]">
				<div class="container">
					<p class="title-content-detail-tour block text-[#3A9923] font-bold text-[20px] mb-[32px]">Đặt vé xe</p>
					<div class="wrap-detail-dat-tour bg-white px-[20px] py-[30px]">
