            ...
            <div class="row flex justify-between">
                <div class="col-12 col-lg-12">
                    <div class="row flex justify-between">
                        ...
                        <div class="col-12 col-12 mt-[34px]">
                ...
                <div class="col-12 col-lg-4 mt-[34px]">
                ...
                <div class="col-12 col-lg-12 mt-[19px]">
                    <p class="text-[#868686] text-[13px] text-center">Copyright© 2023 Ewin Group all rights reserved. Developed by A Website</p>
                </div>
            </div>
        </div>
   </div>
