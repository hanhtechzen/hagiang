<section class="menu" id="menu">
    <div class="desc-menu d-flex flex-wrap justify-content-between">
        <ul class="menu-i d-flex align-items-center justify-content-between">
            ...
            <li>
                <a class="transition <?php if($com=='tour-du-lich') echo 'active'; ?>" href="<?=$tourlistmenu[0]['tenkhongdau'.$lang]?>" title="<?=gioithieu?>"><?=gioithieu?></a>
            </li>
            <li>
                <a class="transition <?php if($com=='chu-de-du-lich') echo 'active'; ?>" href="chu-de-du-lich" title="Chủ đề du lịch">Chủ đề du lịch</a>
            </li>
            <li>
