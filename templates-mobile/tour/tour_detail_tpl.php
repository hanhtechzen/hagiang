<section class="detail-tour bg-[#F4F4F4] py-[50px] pt-0" x-data="ScrollClick()">
	<div class="wrap-detail-top-tour">
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-lg-6 mt-[20px] md:!mt-0 md:!pl-[50px]">
					<div class="top-detail-tour">
						<p class="title-tour-detail capitalize text-[28px] font-Viaoda mb-[20px]"><?=$row_detail['ten'.$lang]?></p>
						<ul class="text-[16px]">
					...
					<div class="book-tour-detail mt-[24px]">
						<a href="javascript:void(0)" @click="clickscroll('#dat-tour')" class="bg-[#3A9923] rounded-[26px] text-center text-[16px] font-bold py-[10px] px-[48px] leading-[24px] uppercase border-[1px] border-[#3A9923] !text-white hover:bg-white hover:!text-[#3A9923] transition-all !block duration-500">ĐẶT NGAY</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="wrap-info-detail-tour mt-[50px]">
		...
		<div class="content-detail-tour">
			<div id="lich-trinh" class="noidung-tour py-[40px] border-b-[1px] border-b-[#000]/[.12]">
				<div class="container">
					<p class="title-content-detail-tour block text-[#3A9923] font-bold text-[20px] mb-[24px]">Lịch trình</p>
					<ul>
						<?php foreach ($lichtrinh as $k => $v) {?>
						<li class="mb-[20px] last:mb-0">
							<p class="title-detail-lichtrinh mb-[24px] text-[#1C1C1C] text-[16px] font-bold"><?=$v['ten'.$lang]?></p>
			...
			<div id="thong-tin" class="noidung-tour py-[40px] border-b-[1px] border-b-[#000]/[.12]">
				<div class="container">
					<p class="title-content-detail-tour block text-[#3A9923] font-bold text-[16px] mb-[24px]">Thông tin</p>
					<div class="noidung-lichtrinh noidung-tour-cke"><?=htmlspecialchars_decode($row_detail['noidung'.$lang])?></div>
				</div>
			</div>
			<div id="dat-tour" class="noidung-tour py-[30px]">
				<div class="container">
					<p class="title-content-detail-tour block text-[#3A9923] font-bold text-[20px] mb-[32px]">Đặt tour</p>
					<div class="wrap-detail-dat-tour bg-white p-[20px] pt-[40px]">
						<div class="title-form-dat-tour text-center mb-[30px]">
							<h6 class="font-Viaoda text-[#3A9923] text-[28px] border-[1px] border-[#3A9923] !border-r-0 leading-[40px] py-[10px] !mb-0 !border-l-0 inline-block">Đăng Ký Đặt Tour</h6>
						</div>
						<div class="wrap-show-form">
							<form method="post" action="" enctype="multipart/form-data">
								<div class="row -mx-[10px] mb-[25px]">
									<div class="col-12 col-input mb-[25px] !px-[10px]">
									...
									<div class="col-12 col-input !px-[10px]">
	...
	<div class="tour-lienquan pt-[40px]">
		<div class="container">
			<div class="title-chill-tour text-center mb-[30px]">
				<p class="uppercase text-[28px] capitalize font-Viaoda">Tour Liên Quan</p>
			</div>
			<div class="main-custom-slide mx-auto max-w-[70%]">
				<div class="row-tour-slick slick-arrows -mx-[12px]">
					<div class="slick in-page" data-dots="0" data-infinite="1" data-responsive="1" data-arrows="1" data-autoplay='1' data-slidesDefault="3:1" data-lg-items='3:1' data-md-items='1:1' data-sm-items='1:1' data-xs-items="1:1" data-vertical="0">
