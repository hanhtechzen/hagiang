    ...
    <script type="text/javascript">
		CKEDITOR.editorConfig = function( config ) {
			...
			[
				...
				'https://fonts.googleapis.com/css2?family=Nunito+Sans:ital,wght@0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,600;1,700;1,800;1,900&family=Viaoda+Libre&display=swap'
			];
			config.font_names = 'Nunito Sans/nunito sans;'+'Viaoda Libre/viaoda libre;' + config.font_names;
			/* All Plugins */
			...
			/* Config Lineheight */
			config.line_height = '1;1.1;1.2;1.3;1.4;1.5;2;2.5;3;3.5;4;4.5;5;20px;22px;25px;28px;';
			config.fontWeight = '200;300;400;600;700;800;900';
			/* Config Word */
...
<body class="">
    ...
    <script src="assets/js/flatpickr.js" defer></script>
