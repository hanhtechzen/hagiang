            	...
            	<div class="card">
            		...
            		<div class="card-body">
						...
						<div class="row">
							...
							<?php } ?>
							<?php if(isset($config['setting']['whatsapp']) && $config['setting']['whatsapp']==true) { ?>
								<div class="form-group col-md-4 col-sm-6">
									<label class="form-label" for="whatsapp">Whatsapp:</label>
									<input type="text" class="form-control" name="data[options][whatsapp]" id="whatsapp" placeholder="Whatsapp" value="<?=@$options['whatsapp']?>">
								</div>
							<?php } ?>
