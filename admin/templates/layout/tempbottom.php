<div class="col-12 col-sm-12 col-md-6 d-none d-md-flex align-items-center justify-content-center justify-content-md-start">
    <?php if($com!='contact' && $com!='order'){?>
    <div class="form-group mb-0 header-top-page-btnaction me-2">
...
<?php if(!empty($paging)) { ?>
<div class="xs:w-100 md:!w-6/12 text-center text-md-right flex items-center justify-center md:justify-end">
