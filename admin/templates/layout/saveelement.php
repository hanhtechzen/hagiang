<div class="col-12 col-sm-12 col-md-6 d-none d-md-flex align-items-center justify-content-center justify-content-md-start">
    <div class="me-2 flex items-center justify-center">
		...
		<button type="reset" class="btn btn-danger flex items-center justify-center">
			Làm lại 
		    <svg class="size-28" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
