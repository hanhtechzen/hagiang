            ...
            <div class="col-md-12">
                <div class="border border-2 rounded">
                    ...
                    <div class="p-3">
                        ...
                        <!-- Font Size -->
                        <div>
                            <h6 class="d-inline-block mb-3 me-2">Font Size </h6>
                        </div>
                        <div class="d-grid gap-3 grid-cols-3 mb-4">
                            <div data-setting="radio">
                                <input type="radio" value="theme-fs-sm" class="btn-check" name="theme_font_size"
                                    id="font-size-sm">
                                <label class="btn btn-border d-block" for="font-size-sm">Font 14px</label>
                            </div>
                            <div data-setting="radio">
                                <input type="radio" value="theme-fs-md" class="btn-check" name="theme_font_size"
                                    id="font-size-md" checked>
                                <label class="btn btn-border d-block" for="font-size-md">Font 15px</label>
                            </div>
                            <div data-setting="radio">
                                <input type="radio" value="theme-fs-lg" class="btn-check" name="theme_font_size"
                                    id="font-size-lg" checked>
                                <label class="btn btn-border d-block" for="font-size-lg">Font 16px</label>
                            </div>
                        </div>
