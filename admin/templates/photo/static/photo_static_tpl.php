            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" id="form-watermark" action="<?=$linkSave?>" enctype="multipart/form-data">
                        ...
                        <?php if(isset($config['photo']['photo_static'][$type]['images2']) && $config['photo']['photo_static'][$type]['images2']==true) { ?>
                        <div class="form-group">
                            <label class="change-photo" for="file-zone2">
                                <p> <b class="text-gray-800">Upload hình ảnh:</b> <span class="text-danger mt-2 mb-2 text-sm"><?php echo "Width: ".$config['photo']['photo_static'][$type]['width']." px - Height: ".$config['photo']['photo_static'][$type]['height']." px (".$config['photo']['photo_static'][$type]['img_type'].")" ?></span></p>
                                <div class="rounded photoUpload-preview flex items-center justify-left " id="photoUpload-preview2">
                                    <img class="rounded img-upload max-w-2xl" src="<?=UPLOAD_PHOTO.$item['photo2']?>" onerror="src='assets/images/noimage.png'" alt="Alt Photo"/>
                                </div>
                            </label>
                            <div class="custom-file my-custom-file mt-3">
                                <label for="file" class="photo-zone" id="photo-zone2">
                                    <input type="file" class="form-control file-zone"  name="file2" id="file-zone2">
                                </label>
                            </div>
                        </div>
                        <?php } ?>
                         ...
                         <?php if(isset($config['photo']['photo_static'][$type]['video_file']) && $config['photo']['photo_static'][$type]['video_file']==true) { ?>
                        <div class="form-group">
                            <label class="change-photo" for="video-file">
                                <p> <b class="text-gray-800">Upload video:</b> <span class="text-danger mt-2 mb-2 text-sm"><?php echo $config['photo']['photo_static'][$type]['video_type'] ?></span></p>
                                <div class="rounded photoUpload-preview flex items-center justify-left ">
                                    <video autoplay muted controls="">
                                        <source src="<?=UPLOAD_PHOTO.$item['video']?>">
                                    </video>
                                </div>
                            </label>
                            <div class="custom-file my-custom-file mt-3">
                                <label for="video-file" class="photo-zone">
                                    <input type="file" class="form-control file-zone" id="video-file" name="file-video">
                                </label>
                            </div>
                        </div>
                        <?php } ?>
