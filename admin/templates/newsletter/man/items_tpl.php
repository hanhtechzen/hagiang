                        ...
                        <table class="table mb-0 w-100" id="datatable">
                            <thead>
                                <tr class="bg-white">
                                    ...
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showname_tour']) && $config['newsletter'][$type]['showname_tour']==true) { ?>
                                        <th class="align-middle">Tên tour</th>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showchude_tour']) && $config['newsletter'][$type]['showchude_tour']==true) { ?>
                                        <th class="align-middle">Chủ đề tour</th>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showngaysudung']) && $config['newsletter'][$type]['showngaysudung']==true) { ?>
                                        <th class="align-middle">Thời gian</th>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showkhachsan']) && $config['newsletter'][$type]['showkhachsan']==true) { ?>
                                        <th class="align-middle">Khách sạn</th>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['shownhahang']) && $config['newsletter'][$type]['shownhahang']==true) { ?>
                                        <th class="align-middle">Nhà hàng</th>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showsonguoi']) && $config['newsletter'][$type]['showsonguoi']==true) { ?>
                                        <th class="align-middle">Số người</th>
                                    <?php } ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showname_tour']) && $config['newsletter'][$type]['showname_tour']==true) { ?>
                                        <td class="align-middle"><?=$items[$i]['name_tour']?></td>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showchude_tour']) && $config['newsletter'][$type]['showchude_tour']==true) { ?>
                                        <td class="align-middle"><?=$items[$i]['chude_tour']?></td>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showngaysudung']) && $config['newsletter'][$type]['showngaysudung']==true) { ?>
                                        <td class="align-middle"><?=$items[$i]['ngaysudung']?></td>
                                    <?php } ?>

                                    <?php if(isset($config['newsletter'][$type]['showkhachsan']) && $config['newsletter'][$type]['showkhachsan']==true) { ?>
                                        <td class="align-middle"><?=$items[$i]['name_khachsan']?></td>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['shownhahang']) && $config['newsletter'][$type]['shownhahang']==true) { ?>
                                        <td class="align-middle"><?=$items[$i]['name_nhahang']?></td>
                                    <?php } ?>
                                    <?php if(isset($config['newsletter'][$type]['showsonguoi']) && $config['newsletter'][$type]['showsonguoi']==true) { ?>
                                        <td class="align-middle"><?=$items[$i]['songuoi']?></td>
                                    <?php } ?>
