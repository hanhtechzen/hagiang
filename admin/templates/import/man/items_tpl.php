	        ...
	        <div class="card card-primary card-outline text-sm mb-0">
	            ...
	            <div class="card-body">
	                ...
	                <div class="form-group mb-0">
	                    <label for="filer-gallery" class="label-filer-gallery mb-3">Album hình: (<?=$config['import']['img_type']?>)</label>
        ...
        <div class="card card-primary card-outline text-sm mb-0">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <strong class="d-block mt-2 mb-2 text-sm">Loại : .xls (Ms.Excel 2003)</strong>
