...
?>
<section class="detail-tour bg-[#F4F4F4] py-[50px] pb-0">
			...
			<div class="row">
				...
				<div class="col-6 col-lg-6 !pl-[50px]">
					...
					<div class="book-tour-detail mt-[24px]">
						<a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal" class="bg-[#3A9923] rounded-[26px] inline-block text-[16px] font-bold py-[10px] px-[48px] leading-[24px] uppercase border-[1px] border-[#3A9923] !text-white hover:bg-white hover:!text-[#3A9923] transition-all duration-500">ĐẶT NGAY</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="wrap-list-thucdon py-[40px] pt-[70px]">
		<div class="container">
			<div class="title-chill-tour text-center mb-[20px]">
				<p class="uppercase text-[40px] capitalize font-Viaoda">Thực đơn tại nhà hàng</p>
			</div>
			<div class="tab-thucdon flex justify-center mb-[40px]">
			...
			<div class="row-tour-slick slick-arrows -mx-[12px]">
				<div class="slick in-page" id="loadthucdon" data-dots="0" data-infinite="1" data-arrows="1" data-autoplay='0' data-slidesDefault="4:1" data-lg-items='4:1' data-md-items='4:1' data-sm-items='4:1' data-xs-items="4:1" data-vertical="0">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="warp-banchay pt-[10px]">
		<div class="container">
			<div class="title-chill-tour text-center mb-[35px]">
				<p class="uppercase text-[40px] capitalize font-Viaoda">Món Ăn Bán Chạy</p>
			</div>
		</div>
				...
				<div class="show-banchay-menu">
					<div class="row -mx-[12px]">
						...
						<div class="col-6 col-lg-6 !px-[12px] mb-[24px]">
							<div class="bloxk-monan flex items-center justify-between">
								<span>
									<img src="<?=THUMBS?>/180x135x1/<?=UPLOAD_PRODUCT_L.$v['photo']?>" alt="<?=$v['ten'.$lang]?>">
								</span>
								<div class="info-monan flex-1 ml-[24px]">
