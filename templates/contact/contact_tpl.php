...
<div class="wrap-contact-page relative z-[10] pb-[40px]">
    <div class="container">
        <div class="wrapper_contant shadow-[0px_0px_50px_rgba(124,124,124,0.15)] rounded-[8px] p-[95px] bg-white -mt-[74px]">
    ...
    <section class="contact_bottom relative mt-[80px]">
        <div class="container">
            <div class="info_contant_content">
                <div class="row">
                    <div class="col-6 col-lg-6 col_text_info_contant_content">
                        <?=htmlspecialchars_decode($lienhe['noidung'.$lang])?>
                    </div>
                    <div class="col-6 col-lg-6 col_map_info_contant_content">
