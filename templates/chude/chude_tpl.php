				...
				<div class="col-5 col-lg-5">
					<div class="bloxk-w-datngay bg-[#FFFFFF]/[.92] py-[48px] px-[24px]">
						<div class="title-header-datngay text-center px-[24px] mb-[40px]">
							<h3 class="text-[#3A9923] text-[32px] uppercase font-bold">ĐẶT NGAY</h3>
							<p class="text-[16px] text-[#1C1C1C] uppercase">CHỈ GÓI VÀ ĐI! HÃY ĐỂ LẠI KẾ HOẠCH DU LỊCH CỦA BẠN ĐỂ TRẢI NGHIỆM DU LỊCH</p>
						</div>
