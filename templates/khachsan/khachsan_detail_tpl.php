...
?>
<section class="detail-tour bg-[#F4F4F4] py-[50px] pb-0" x-data="LoadHtml()">
			...
			<div id="hang-phong" class="noidung-tour py-[40px] border-b-[1px] border-b-[#000]/[.12]">
				<div class="container">
					...
					<div class="list-hangphong">
						...
						<div class="bloxk-hangphong flex flex-wrap items-center bg-white p-[24px] mb-[24px] last:!mb-0">
							<div class="img-phong">
								<img src="<?=THUMBS?>/346x252x1/<?=UPLOAD_PRODUCT_L.$v['photo']?>" alt="<?=$v['ten'.$lang]?>">
							</div>
							<div class="info-phong flex-1 pl-[37px]">
								<h3 class="text-[20px] font-bold text-[#1C1C1C] mb-[20px]"><?=$v['ten'.$lang]?></h3>
								<ul class="-mx-[10px] flex flex-wrap">
									<li class="w-6/12 px-[10px] mb-[24px]">
								...
								<div class="tool-mota-gioithieu flex items-center justify-start mt-[24px]">
									<a href="javascript:void(0)" @click="LoadInfoPhong(<?=$v['id']?>)" class="rounded-[26px] mr-[23px] border-[1px] border-[#3A9923] font-bold bg-white text-[16px] text-[#3A9923] px-[40px] py-[10px] uppercase transition-all hover:!bg-[#3A9923] hover:!text-white">XEM CHI TIẾT PHÒNG</a>
									<a href="javascript:void(0)" @click="BookPhong('<?=$v['ten'.$lang]?>')" class="rounded-[26px] border-[1px] border-[#3A9923] bg-[#3A9923] font-bold text-[16px] text-white px-[40px] py-[10px] uppercase transition-all hover:!bg-white hover:!text-[#3A9923]">ĐẶT NGAY</a>
								</div>
							</div>
						</div>
						<?php }?>
	...
	<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog !max-w-[1200px] modal-dialog-centered" role="document">
			<div class="modal-content relative">
				<button type="button" class="close absolute top-[15px] z-[30] right-[15px] opacity-100 !outline-0" data-dismiss="modal" aria-label="Close">
          			<span aria-hidden="true" class="text-[37px]">&times;</span>
        		</button>
				<div class="modal-body">
					<div class="row -mx-[20px]">
						<div class="col-6 col-lg-6 px-[20px]" id="showlist">
							
						</div>
						<div class="col-6 col-lg-6 px-[20px]">
							<div class="show-info-phong"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-content">
				<div class="modal-body relative">
					...
					<div class="title-form-dat-tour text-center mb-[60px]">
						<h6 class="font-Viaoda text-[#1C1C1C] text-[32px] leading-[44px] py-[10px] px-[70px] !mb-0 !border-l-0 inline-block">Thông tin đặt Khách Sạn <span class="text-[#3A9923]"><?=$pro_list['ten'.$lang]?></span></h6>
					</div>
