...
<div class="modal fade" id="DatVeexampleModal" tabindex="-1" role="dialog" aria-labelledby="DatVeexampleLabel" aria-hidden="true">
		...
		<div class="modal-content">
			<div class="modal-body relative">
				...
				<div class="title-form-dat-tour text-center mb-[60px]">
					<h6 class="font-Viaoda text-[#1C1C1C] text-[32px] leading-[44px] py-[10px] px-[70px] !mb-0 !border-l-0 inline-block">Thông tin đặt vé</h6>
				</div>
				<div class="wrap-show-form">
					<form method="post" id="form-recaptchaResponseDatVeNgay" action="" enctype="multipart/form-data">
						...
						<div class="row -mx-[20px] mb-[40px]">
							...
							<div class="col-6 col-input !px-[20px]">
								...
								<?php /* <input type="text" class="form-input w-full placeholder:text-[#868686] focus:ring-[#3A9923] focus:border-[#3A9923] text-[#868686] text-[15px] !border-0 !px-0 !border-b-[1px] border-[#000]/[.12] !ring-0 !shadow-none !outline-0" list="list-uoctinh" required="" name="data[time_uoctinh]" placeholder="Thời gian ước tính ở lại">
