<?php
	...
	if(isset($_POST['thanhtoan']))
	{
	    ...
	    $hoten = htmlspecialchars($_POST['ten']);
	    ...
	    $httt = htmlspecialchars($_POST['payments']);
	    $htttText = $func->get_payments($httt);
	    $yeucaukhac = htmlspecialchars($_POST['yeucaukhac']);
