<?php  
	...
	{
		/* Lấy cấp 1 detail */
		$pro_list = $d->rawQueryOne("select id, ten$lang, tenkhongdauvi, tenkhongdauen, type, photo, options,mota$lang,tieude$lang from #_product_list where id = ? and type = ? limit 0,1",array($idl,$type));
