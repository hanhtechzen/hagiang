...
<link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:ital,wght@0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,600;1,700;1,800;1,900&family=Viaoda+Libre&display=swap" rel="stylesheet">
<?php
    $css->setCache("cached-mobile");
    $css->setCss("./assets/css/animate.min.css");
    $css->setCss("./assets/css/style-tailwind.css");
    ...
    $css->setCss("./assets/css/flatpickr.css");
    $css->setCss("./assets/css/flickity.css");
    $css->setCss("./assets/css/HoldOn.css");
    $css->setCss("./assets/css/style-mobile.css");
    echo $css->getCss();
?>
