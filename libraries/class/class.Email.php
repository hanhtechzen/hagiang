	...
	class Email
	{
		...
		public function infoEmail()
		{
			...
			if($social && count($social) > 0)
			{
				...
				{
					$socialString .= '<a href="'.$value['link'].'" target="_blank"><img src="'.$config_base.UPLOAD_PHOTO_L.$value['photo'].'" style="max-height:60px;margin:0 0 0 5px" /></a>';
				}
			}

			$this->data['email'] = ($this->optcompany['mailertype']==1) ? $this->optcompany['email_host'] : $this->optcompany['email_gmail'];
			$this->data['color'] = '#3a9923';
