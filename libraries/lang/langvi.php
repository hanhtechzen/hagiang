...
define("nhapmauudai","Nhập mã ưu đãi");
define("xoa","Xóa");
...
define("chuanhapmauudai","Chưa nhập mã ưu đãi");
...
define("trongthang","Thống kê tháng");
define("chinhsach","Chính sách hỗ trợ");
define("thuonghieu","Thương hiệu");
define("uudai","Ưu đãi");
define("chuacouudai","Chưa có ưu đãi");
define("mauudaidahethan","Mã ưu đãi đã hết hạng");
define("mauudaidaduocsudunghoackhongtontai","Mã ưu đãi đã được sử dụng hoặc không tồn tại");
...
define("hotro","Hỗ trợ");
define("tochuc","Tổ chức");
define("sukien","Sự kiện");
define("thietbisukien","Thiết bị sự kiện");
define("hoatdong","Hoạt động");
