...
<?php if($type == 'footer-map') { echo htmlspecialchars_decode($optsetting['toado_iframe']); } ?>
...
<?php if($type == 'script-main') { ?>
	...
	<script>(function(d, s, id) {
	    ...
	    js.src = "//connect.facebook.net/<?=($lang=='vi')?'vi_VN':'en_EN'?>/sdk.js#xfbml=1&version=v2.6";
